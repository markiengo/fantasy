const I18n = (() => {
  ...
  const dict = {
    en: {
      ...
      "login.loading_desk": "Loading your matchday desk…",
      "login.or": "Or",
      ...
      "chart.manual_adjustment": "Manual adjustment",
      ...
      "dash.round_points": "Round points",
      "dash.your_round_points": "Your score and rank in each round",
      "dash.round_rank": "Round rank",
      "dash.your_round_rank": "Your leaderboard position in each round",
      "dash.round_points_detail": "{0}: {1} pts, rank {2} of {3}",
      "dash.round_points_admin_detail": "{0}: {1} pts",
      ...
      "dash.loading_round_points": "Loading points by round…",
      "dash.loading_round_rank": "Loading leaderboard ranks…",
      ...
      "lb.round_points": "Round Points",
      "lb.popular": "Popular Picks",
      "lb.view_switcher": "Leaderboard views",
      "lb.leader": "Leader",
      "lb.you": "You",
      "lb.admin": "Admin",
    ...
    vi: {
      ...
      "login.loading_desk": "Đang tải bàn điều khiển trận đấu…",
      "login.or": "Hoặc",
      ...
      "chart.manual_adjustment": "Điều chỉnh thủ công",
      ...
      "dash.round_points": "Điểm từng vòng",
      "dash.your_round_points": "Điểm và thứ hạng của bạn ở mỗi vòng",
      "dash.round_rank": "Thứ hạng từng vòng",
      "dash.your_round_rank": "Vị trí của bạn trên bảng xếp hạng ở mỗi vòng",
      "dash.round_points_detail": "{0}: {1} điểm, hạng {2} trên {3}",
      "dash.round_points_admin_detail": "{0}: {1} điểm",
      ...
      "dash.loading_round_points": "Đang tải điểm từng vòng…",
      "dash.loading_round_rank": "Đang tải thứ hạng bảng xếp hạng…",
      ...
      "lb.round_points": "Điểm vòng đấu",
      "lb.popular": "Lựa chọn phổ biến",
      "lb.view_switcher": "Chế độ bảng xếp hạng",
      "lb.leader": "Dẫn đầu",
      "lb.you": "Bạn",
      "lb.admin": "Quản trị",

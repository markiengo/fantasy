const I18n = (() => {
  ...
  const dict = {
    en: {
      ...
      "hts.note_gkdef": "Goalkeepers and defenders also earn clean-sheet points, +1 per save (GK), and score +7 for goals.",
      "hts.note_midfwd": "Midfielders and forwards score +5 for goals and +1 per shot on target, plus the shared points.",
    ...
    vi: {
      ...
      "stats.top_saves": "Phản saves nhiều nhất",
      "stats.hint_total": "Tổng",
      "stats.hint_saves": "Phản saves",
      ...
      "hts.saves": "Phản saves",
      "hts.own_goals": "Bàn phản lưới",
      "hts.shots_on_target": "Cú sút trúng đích",
      ...
      "hts.note_gkdef": "Thủ môn và hậu vệ cũng được điểm không thủng lưới, +1 mỗi cú phản saves (TM), và ghi +7 cho bàn thắng.",
      "hts.note_midfwd": "Tiền vệ và tiền đạo ghi +5 cho bàn thắng và +1 mỗi cú sút trúng đích, cộng với điểm chung.",

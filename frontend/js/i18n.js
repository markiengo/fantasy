const I18n = (() => {
  ...
  const dict = {
    en: {
      ...
      "hts.note_gkdef": "Goalkeepers and defenders also earn clean-sheet points and score +6 for goals.",
      "hts.note_midfwd": "Midfielders and forwards score +5 for goals, plus the shared points.",
    ...
    vi: {
      ...
      "hts.note_gkdef": "Thủ môn và hậu vệ cũng được điểm không thủng lưới và ghi +6 cho bàn thắng.",
      "hts.note_midfwd": "Tiền vệ và tiền đạo ghi +5 cho bàn thắng, cộng với điểm chung.",
